...
<form method="POST">
    <?php if (isset($username) && !empty($username)) : ?>
        <input class="form-control" type="hidden" name="username" value="<?php se($username, false); ?>" />
    <?php endif; ?>
    <table>
        <thead>
            <th>Users</th>
                        ...
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                <td>
                                    ...
                                    <input class="form-control" id="user_<?php se($user, 'id'); ?>" type="checkbox" name="users[]" value="<?php se($user, 'id'); ?>" />
                                </td>
                ...
                <td>
                    <?php foreach ($active_roles as $role) : ?>
                        <div>
                            ...
                            <input class="form-control" id="role_<?php se($role, 'id'); ?>" type="checkbox" name="roles[]" value="<?php se($role, 'id'); ?>" />
                        </div>
                    <?php endforeach; ?>
                </td>
            </tr>
